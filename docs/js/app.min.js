...
// $rootScope
$rootScope.$state=$state,$rootScope.$stateParams=$stateParams,$rootScope.cache={},$rootScope.config={years:[{label:"2020-21",base:"appt3M1gC5W7bf5Kh",key:"keypmXJ00DbWmRvx9",table:"tblZZdvYeco7W2Pa8"}],admins:{"jeffrey.m.lyon@gmail.com":{role:"admin"},"lisa.perloff@gmail.com":{role:"admin"},"lperloff@husd.k12.ca.us":{role:"admin"}},default_year:"2020-21"},
