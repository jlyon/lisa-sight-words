...
// $rootScope
$rootScope.$state=$state,$rootScope.$stateParams=$stateParams,$rootScope.cache={},$rootScope.config={years:[{label:"2020-21",base:"appArZiLlaI2Oor0E",key:"keypmXJ00DbWmRvx9",table:"tbl6nqMtXha2zbbqv"}],admins:{"jeffrey.m.lyon@gmail.com":{role:"admin"},"lisa.perloff@gmail.com":{role:"admin",teacher:"lisa"}},default_year:"2020-21"},
